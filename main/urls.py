...
urlpatterns = [
    url(r'^$', views.TransactionView.as_view(), name='cost'),
    url(r'^add/$', views.TransactionCreateView.as_view(), name='cost_add'),
    url(r'^(?P<pk>[-\w]+)/update/$', views.TransactionUpdateView.as_view(), name='cost_update'),
    url(r'^(?P<pk>[-\w]+)/delete/$', views.TransactionDeleteView.as_view(), name='cost_delete'),
